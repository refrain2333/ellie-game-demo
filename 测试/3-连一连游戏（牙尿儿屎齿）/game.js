...
// ────── 游戏数据 ──────
const BASE_ITEMS = [
    { id: "item1", topImg: "./img/ya_2.png", bottomImg: "./img/ya_1.png", alt: "牙", color: "#ff6b6b" },
    { id: "item2", topImg: "./img/niao_2.png", bottomImg: "./img/niao_1.png", alt: "尿", color: "#4d96ff" },
    { id: "item3", topImg: "./img/er_2.png", bottomImg: "./img/er_1.png", alt: "儿", color: "#6bcb77" },
    { id: "item4", topImg: "./img/shi_2.png", bottomImg: "./img/shi_1.png", alt: "屎", color: "#ffd93d" },
    { id: "item5", topImg: "./img/chi_2.png", bottomImg: "./img/chi_1.png", alt: "齿", color: "#a78bfa" }
];
